...
const videos = [
  { title: 'Attabad Lake Adventure', description: 'Cinematic lake footage from the heart of Gilgit-Baltistan.', tag: 'Travel', videoUrl: 'videos/Attabad Lake ❣️….mp4', sortOrder: 1 },
  { title: 'Boat Escape on Attabad Lake', description: 'A scenic boat journey across the blue waters of Attabad.', tag: 'Travel', videoUrl: 'videos/Attabad Lake 🛥️⛵️ ….mp4', sortOrder: 2 },
  { title: 'Mark X Commercial Shoot', description: 'A high-energy commercial production capturing the Mark X.', tag: 'Commercial', videoUrl: 'videos/Commercial Mark X Shoot 🥵 …Great Work Bois . Team - GB Secrets ❣️ …Mark X 2010 model double eco.mp4', sortOrder: 3 },
  { title: 'Empowering Women Stories', description: 'A powerful story-driven film celebrating women’s empowerment.', tag: 'Story', videoUrl: 'videos/Empowering Women, Capturing Stories - AKRSP x Syed Production ✨ ….....#womenempowerment #akrsp #.mp4', sortOrder: 4 },
  { title: 'Shahrukh & Sehrish Wedding Story', description: 'A romantic wedding story captured with cinematic detail.', tag: 'Client Story', videoUrl: 'videos/Every day is the best day when I’m with you ❣️… Shahrukh & Sehrish The story of a wedding in Att.mp4', sortOrder: 5 },
  { title: 'Gilgit Baltistan Journey', description: 'Dynamic scenery and storytelling from the mountains of Gilgit.', tag: 'Travel', videoUrl: 'videos/Gilgit Baltistan 🥵 ….mp4', sortOrder: 6 },
  { title: 'Hunza Highlights', description: 'A fast-paced reel showcasing Hunza’s most stunning locations.', tag: 'Cinematic', videoUrl: 'videos/Hunza ♥️ #reels #gbsecrets.mp4', sortOrder: 7 },
  { title: 'Naltar Snow Story', description: 'A snowy winter reel from Naltar’s breathtaking valleys.', tag: 'Cinematic', videoUrl: 'videos/Naltar ❄️.mp4', sortOrder: 8 }
];
